...
**Objective:** Analyze housing market trends in King County, WA, to uncover key price drivers and patterns in real estate performance.

[🔗 **View Interactive Dashboard on Tableau Public**](https://public.tableau.com/app/profile/arriel.houston/viz/KingCountyHouseSales_17622084570380/KingCountyHouseSales)
...
- Created calculated fields (e.g., price per square foot, house age).  
- Built an interactive dashboard to explore prices by region, condition, and property features.  
- Highlighted important KPIs for quick and data-driven insights.
...
- **Dynamic Filters:** Adjust views by bedrooms, bathrooms, year built, or renovation status.  
- **Summary Cards:** Quick insights for average price, total sales, and property age.
...
- **Price Efficiency:** Smaller but upgraded homes often outperform larger dated ones on a per-square-foot basis.  
- **Seasonal Trends:** Sales activity and prices peak during spring and summer months.  
...
- Create a **mobile-friendly** version for easier viewing.  
